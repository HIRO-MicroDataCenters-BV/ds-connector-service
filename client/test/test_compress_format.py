...
class TestCompressFormat(unittest.TestCase):
    """CompressFormat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompressFormat:
        """Test CompressFormat
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompressFormat`
        """
        model = CompressFormat()
        if include_optional:
