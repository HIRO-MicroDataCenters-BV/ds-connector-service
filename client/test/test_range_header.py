...
class TestRangeHeader(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RangeHeader:
        """Test RangeHeader
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RangeHeader`
        """
        model = RangeHeader()
        if include_optional:
            return RangeHeader(
