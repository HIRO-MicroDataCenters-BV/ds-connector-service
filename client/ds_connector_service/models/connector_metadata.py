...
class ConnectorMetadata(BaseModel):
    ...
    region: StrictStr
    supported_interfaces: List[StrictStr]
    status: StrictStr
    version: StrictStr
    __properties: ClassVar[List[str]] = ["connector_id", "region", "supported_interfaces", "status", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supported_interfaces": obj.get("supported_interfaces"),
