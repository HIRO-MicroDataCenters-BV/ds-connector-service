...
class ClientFactory:
    ...
    def register_client(self, source_type: SourceType, client: BaseReadDataClient):
    ...
    def get_client(self, source_type: SourceType = None) -> BaseReadDataClient:
    ...
    def get_client_by_name(self, client_name: str) -> BaseReadDataClient:
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"No client registered for: {client_name}")
